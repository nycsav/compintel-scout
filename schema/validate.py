...
def validate_competitor(payload: Mapping[str, Any]) -> ValidationResult:
    """Validate a competitor payload."""
    return validate_payload(payload, "competitor")


def validate_signal(payload: Mapping[str, Any]) -> ValidationResult:
    """Validate a signal payload."""
    return validate_payload(payload, "signal")
